...
class TypoDetector:
    ...
    def analyze_failed_search(self, 
                            target_name: str, 
                            scope_config: dict[str, Any] | str,
                            ast_tree: ast.Module,
                            file_path: str) -> TypoSuggestion:
        ...
        candidates = self.scope_analyzer.extract_names_in_scope(
            ast_tree, scope_config, target_type
        )
    ...
    def _infer_target_type(self, target_name: str) -> str:
        ...
        # Constants/variables (ALL_CAPS or snake_case with underscores)
            ...
            function_patterns = ['process', 'init', 'update', 'render', 'create', 'delete', 'get', 'set', 'run', 'start', 'stop']
